...
export const FilesObserverNode: React.FC<IFileObserverNode> = (item) => {
  return (
    <tr className="border-b border-gray-200 font-normal" >
      <td className="px-4 py-3 hover:text-violet-400">
        <a href="javascript:;">
          <span className="mr-1 text-indigo-500">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="inline-block bi bi-folder-fill" viewBox="0 0 16 16">
